                ...
                <div class="reader-ayat-card reveal-ayat" id="ayah-${ayah.verse_key}" data-verse-key="${ayah.verse_key}" style="animation-delay: ${i * 0.1}s; padding-bottom: 2rem; border-bottom: 1px solid rgba(255,255,255,0.05); margin-bottom: 2rem;">
                    ...
                    <div class="translation-group" style="margin-top: 2rem; display: none; border-top: 1px solid rgba(255,255,255,0.05); padding-top: 2rem;">
                        <div class="reader-trans-item">
                            ...
                            <div class="trans-text-main ${selectedTranslationLang === 'en' ? '' : 'urdu-font-reader'}" style="font-size: 1.4rem; color: #f5f5f7; margin-top: 0.5rem; text-align: ${selectedTranslationLang === 'en' ? 'left' : 'right'};">
                                ${selectedTranslationLang === 'en' ? engFull : urduFull}
                            </div>
                        </div>
                    </div>
                </div>
